...
def math_chatbot():
    ...
    #Tool to search for specific information
    ...
    #Tool to compute mathematical operations. 
    problem_chain = LLMMathChain.from_llm(llm=llm)
    math_tool = Tool.from_function(name="Calculator",func=problem_chain.run,description="Useful for when you need to answer questions about math. This tool is only for math questions and nothing else. Only input math expressions.")
    ...
    word_problem_tool = Tool.from_function(name="Reasoning Tool",func=word_problem_chain.run,description="Useful to solve and answer reasoning based or logic-based questions.")

    #Choose a problem specific tool
